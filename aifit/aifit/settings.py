"""
Django settings for aifit project.
...
SECRET_KEY = 'django-insecure-029b+r*tv)y102*=#6pn&hkzdtzc2^6hdh^%++5k&%cmen5!vz'
...
WSGI_APPLICATION = 'aifit.wsgi.application'
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'aifit_app/static/')
